Function Get-EducationDepartments
{
    Begin{
        ...
        $endpoint = 'https://api.sky.blackbaud.com/constituent/v1/educations/departments'
        $endUrl = ''
    ...
    Process{
        ...
        $obj_list = $data.value | Select-Object @{Name='department';Expression={$_}}
