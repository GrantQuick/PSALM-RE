Function Get-EmailAddressTypes
{
    Begin{
        ...
        $endpoint = 'https://api.sky.blackbaud.com/constituent/v1/emailaddresstypes'
        $endUrl = ''
    ...
    Process{
        ...
        $obj_list = $data.value | Select-Object @{Name='email_address_type';Expression={$_}}
