Function Get-EducationDegreeClasses
{
    Begin{
        ...
        $endpoint = 'https://api.sky.blackbaud.com/constituent/v1/educations/degreeclasses'
        $endUrl = ''
    ...
    Process{
        ...
        $obj_list = $data.value | Select-Object @{Name='degree_class';Expression={$_}}
