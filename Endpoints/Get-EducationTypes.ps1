Function Get-EducationTypes
{
    Begin{
        ...
        $endpoint = 'https://api.sky.blackbaud.com/constituent/v1/educations/types'
        $endUrl = ''
    ...
    Process{
        ...
        $obj_list = $data.value | Select-Object @{Name='type';Expression={$_}}
