Function Get-AttachmentTags
{
    Begin{
        ...
        $endpoint = 'https://api.sky.blackbaud.com/constituent/v1/attachmenttags'
        $endUrl = ''
    ...
    Process{
        ...
        $obj_list = $data.value | Select-Object @{Name='attachment_tag';Expression={$_}}
