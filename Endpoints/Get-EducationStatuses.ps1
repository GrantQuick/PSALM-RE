Function Get-EducationStatuses
{
    Begin{
        ...
        $endpoint = 'https://api.sky.blackbaud.com/constituent/v1/educations/statuses'
        $endUrl = ''
    ...
    Process{
        ...
        $obj_list = $data.value | Select-Object @{Name='status';Expression={$_}}
