Function Get-ActionLocations
{
    Begin{
        ...
        $endpoint = 'https://api.sky.blackbaud.com/constituent/v1/actionlocations'
        $endUrl = ''
    ...
    Process{
        ...
        $obj_list = $data.value | Select-Object @{Name='action_location';Expression={$_}}
