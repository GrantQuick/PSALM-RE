Function New-OnlinePresence
{
    ...
    Begin{
        ...
        $endpoint = 'https://api.sky.blackbaud.com/constituent/v1/onlinepresences'
    ...
    Process{
        ...
        $constituent_id | ForEach-Object {
            $i++
            Write-Host "Adding online presence to Constituent ID $_ (record $i of $($constituent_id.Length))"
